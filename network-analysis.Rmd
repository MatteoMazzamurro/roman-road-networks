...
# provinces
#provinces_sf <- read_sf("./data/roman_provinces/roman_provinces.shp") # Full 3D version (not on GitHub)
provinces_sf <- read_sf("./data/roman_provinces_simple/roman_provinces.shp") # OLD 3D version

# cities
cities_df <- read.csv("./data/Hanson_size_population.csv")

# provincial capitals
provincial_capitals_df <- read.csv("./data/provincial_capitals_2.csv") 
...
provincial_capitals_with_centrality_sf <- provincial_capitals_sf %>%
  ...
  cbind(data.frame(st_coordinates(provincial_capitals_with_centrality_sf)) %>% setNames(c("lon","lat")))
...
non_capital_centrality <- cities_centrality[!
  cities_centrality$netlogoID %in% na.omit(provincial_capitals_df$netlogoID_Hanson),]
